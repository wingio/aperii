...
export default function MobilePostBtn({user, hasTabBar}) {
    ...
    return (
        ...
        <button onClick={() => {setOpened(true); setVanished(false)}} style={{border: "none", padding: "0", position: "fixed", bottom: "calc(60px + 0.5em)", right: "0.5em", borderRadius: "50%", background: "var(--rust-blood)", width:"4rem", height:"4rem", fontSize: "3rem", fontWeight: "bolder", color: "white", display:"flex"}}>
